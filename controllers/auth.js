    ...
    try{
        ...
        if(dept=="CSE"){
            db.query('SELECT * FROM cse',(err,results)=>{
                ...
                res.render('timetab',{userdata: results,dept:"COMPUTER SCIENCE"});
            });
        ...
        if(dept=="ECE"){
            db.query('SELECT * FROM ece',(err,results)=>{
                ...
                res.render('timetab',{userdata: results,dept:"ECE"});
            });
        ...
        if(dept=="MEC"){
            db.query('SELECT * FROM mec',(err,results)=>{
                ...
                res.render('timetab',{userdata: results,dept:"MECHANICAL"});
            });
        ...
        if(dept=="AERO"){
            db.query('SELECT * FROM aero',(err,results)=>{
                ...
                res.render('timetab',{userdata: results,dept:"AERONATICAL"});
            });
        ...
        if(dept=="CIVIL"){
            db.query('SELECT * FROM civil',(err,results)=>{
                ...
                res.render('timetab',{userdata: results,dept:"CIVIL"});
            });
